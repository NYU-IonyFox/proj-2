...
def run_expert_2(input_data: dict) -> dict:
    """
    Run Expert 2 (Data, Content & Behavioral Safety) and apply all five
    post-processing steps in mandatory order.
    """
    result = run_expert("expert_2", input_data)
    ...
    # Step 2
    validate_anchors(result, _ANCHORS, _EXPERT_ANCHOR_KEY["expert_2"])
    # Step 3
